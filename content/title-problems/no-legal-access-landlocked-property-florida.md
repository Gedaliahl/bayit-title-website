...
quick_facts:
  ...
  - term: "Typical timeline"
    detail: "[VERIFY: how long it has taken us to resolve an access exception by recorded easement, where the neighbouring owner cooperated]"
  - term: "Cost impact"
    detail: "[VERIFY: cost of a recorded easement, survey sketch and legal description preparation]"
---
...
[VERIFY: the standard access exception language used in our commitments, and whether an endorsement is available to insure access — needs the actual form language and First American's position]
