...
summary: "A seller abroad can sign a Florida closing by remote online notarization, before a US consular officer, or before a local notary. Settle which one early."
seo_title: "Foreign seller signing a Florida closing from abroad"
...
quick_facts:
  ...
  - term: "Cost impact"
    detail: "A US consular notarial act is $50 per seal under item 41 of the State Department's schedule of fees, [22 CFR 22.1](https://www.law.cornell.edu/cfr/text/22/22.1), and each additional seal provided at the same time in the same transaction is charged at the same rate — so a signing with several documents is several fees, not one. Apostille and legalization fees are set by the issuing country and vary widely, and international courier for wet-ink originals is priced by the route. We do not publish a figure for either, because there is no figure that holds across countries. Ask us on the file and we will price the actual route."
---
