...
4. **No superlatives, and no comparison naming or characterising another agency.** Florida regulates advertising by licensed title agencies. Never write best, top, #1, fastest, cheapest, or anything that names or characterises a competitor — no "unlike other title companies," no claims about how anyone else works.
   ...
   The firm has decided the site should say plainly that its work is **excellent**. That claim is always cashed out immediately into specific, checkable things — who reads the search, when a problem is put in writing and in what form, who is on the file from opening to recording, who answers the phone — and corroborated by the Google reviews, quoted in full and unedited. Excellence is *evidenced*, never asserted on its own.

   **Do not argue it by comparing premiums.** The firm has asked that the site not frame its case as "the premium is the same at every agency, so all that is left is execution," and not say that another agency's quote must be lower on some other line. Explaining that rates are promulgated by OIR under R. 69O-186.003 is fine and necessary on the cost pages — that is what makes the published schedule authoritative and the calculators checkable — but state it as the rule's own doing, with the citation, not as a comparison against other agencies' pricing.
...
- **Florida Statutes** (leg.state.fl.us / Online Sunshine): ch. 627 part VI (title insurance), ch. 695 (recording), ch. 697, ch. 701 (mortgage satisfactions), ch. 712 (MRTA), ch. 713 (construction liens), ch. 718 (condominiums), ch. 720 (HOAs), ch. 733 (probate administration), ch. 732 (intestate succession/homestead), ch. 197 (tax deeds), ch. 201 (documentary stamp tax), ch. 199 (intangible tax), ch. 117 (notaries/RON), ch. 689 (conveyances), ch. 28 (clerk service charges and recording fees), ch. 48 (lis pendens), ch. 55 (judgment liens and post-judgment interest), ch. 125 (the discretionary surtax on documents), ch. 162 (code enforcement liens), ch. 704 (easements and ways of necessity), ch. 626 (title agency escrow and trust funds, § 626.8473), ch. 475 (broker escrow disputes, § 475.25(1)(d)), ch. 717 (unclaimed property).
- **The Florida Bar** (floridabar.org), including the Florida Rules of Civil Procedure (Rule 1.240, interpleader). The FAR/BAR contract forms are licensed and not published there.
- **Florida Realtors/Florida Bar "AS IS" Residential Contract For Sale And Purchase**, form ASIS-7x (2026 revision), from the copy the team supplied on 25 September 2026. Quote it by paragraph; do not generalise it to the standard (non-AS IS) form, which has not been read.
...
**Chapters 626, 475 and 717 were added on 25 September 2026** for the disputed-deposit page, each read on Online Sunshine first. The team confirmed Online Sunshine and The Florida Bar as approved sources.
