...
-- all of them, including TRUNCATE, which RLS does not govern at all.
revoke all on public.leads, public.orders, public.order_documents from anon, authenticated;
