...
from its own files. A page names only a government office, First American or
the team as a source — never another title agency, another underwriter, a law
firm or a lender (`docs/county-payer-custom.md`).
