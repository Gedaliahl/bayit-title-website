      ...
      <div className="measure">
        ...
        <ul>
          ...
          <li>
            ...
            statewide parcel roll and the U.S. Census Bureau&rsquo;s address geocoder. The address
            is not written to our database, not emailed to the office and not kept after the answer
            comes back, and it is sent as a POST so it does not appear in a server log the way a
            search in a web address would.
          </li>
          <li>
