...
export async function GET() {
  ...
  const lines = [
    ...
    '  Fla. Admin. Code R. 69O-186.003, so the premium for a given coverage amount is identical at every',
    '  agency in the state and cannot be discounted by any of them.',
    '',
